...
function EditProduct() {
  ...
  async function handleSubmit(e) {
    ...
    Object.keys(formfields).forEach((key) => {
      ...
      } else if (key === "category" && typeof formfields[key] === "object") {
        data.append(key, formfields[key]._id); 
      } else {
    ...
    try {
      let response = await updateData(`/api/product/updateProduct/${id}`, data);
      if (response.success) {
  ...
  console.log(formfields.category);
  return (
